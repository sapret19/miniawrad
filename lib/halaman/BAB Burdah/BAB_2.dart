...
import 'package:awrad/model/model_burdah2.dart';
...
class _BurdahState extends State<Burdah> {
  Future<List<ModelBurdah2>> ReadJsonData() async {
    final JsonData =
        await rootBundle.rootBundle.loadString('assets/data/burdah2.json');
    final list = json.decode(JsonData) as List<dynamic>;
    return list.map((e) => ModelBurdah2.fromJson(e)).toList();
  }
      ...
      body: FutureBuilder(
          ...
          builder: (context, data) {
            if (data.hasError) {
              ...
              var items = data.data as List<ModelBurdah2>;
