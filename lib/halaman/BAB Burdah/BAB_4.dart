...
import 'package:awrad/model/model_burdah4.dart';
...
class _BurdahState extends State<Burdah> {
  Future<List<ModelBurdah4>> ReadJsonData() async {
    final JsonData =
        await rootBundle.rootBundle.loadString('assets/data/burdah4.json');
    final list = json.decode(JsonData) as List<dynamic>;
    return list.map((e) => ModelBurdah4.fromJson(e)).toList();
  }
      ...
      body: FutureBuilder(
          ...
          builder: (context, data) {
            if (data.hasError) {
              ...
              var items = data.data as List<ModelBurdah4>;
