...
class Istighosah extends StatefulWidget {
  const Istighosah({super.key});

  @override
  State<Istighosah> createState() => _IstighosahState();
}

class _IstighosahState extends State<Istighosah> {
  ...
  // Future<List<ModelJudul>> ReadJsonData1() async {
  //   final JsonData =
  //       await rootBundle.rootBundle.loadString('assets/data/istighosah.json');
  //   final list = json.decode(JsonData) as List<dynamic>;
  //   return list.map((e) => ModelJudul.fromJson(e)).toList();
  // }
